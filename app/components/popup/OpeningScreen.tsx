// FIRST POPUP DESKTOP DAN MOBILE
    ...
    return (
        ...
        >
            ...
            <div className="hidden lg:flex relative w-full max-w-[500px] aspect-[4/5] flex-col items-center justify-center text-center">
                ...
                <Image src="/image/hero/BARENG.png" alt="bareng" width={600} height={495} className="absolute top-[85%] md:top-[47%] lg:top-[18.8%] left-1/2 -translate-x-1/2 scale-100 md:scale-100" />

                <Image src="/image/hero/UUN text.png" alt="uun" width={285} height={160} className="absolute top-[103%] md:top-[80%] lg:top-[37.2%] right-[6%] md:right-[33.5%] lg:right-[20%] z-30 scale-[0.7] md:scale-100" />

                <Image src="/image/hero/VOLUME 2.png" alt="volume" width={133} height={105} className="absolute top-[23%] md:top-[7%] lg:-top-[7%] left-[65%] md:left-[65%] lg:left-[72%] scale-[0.8] md:scale-100" />

                <Image src="/image/hero/WAVE LINE KANAN ATAS.png" alt="wave" width={115} height={95} className="absolute top-[63%] md:top-[36%] lg:top-[10.7%] right-[78%] md:right-[13%] lg:right-[82%] scale-[0.7] md:scale-100" />

                <Image src="/image/hero/ZIG-ZAG LINE KANAN BAWAH.png" alt="zigzag" width={150} height={142} className="absolute top-[112%] md:top-[73%] lg:top-[33.7%] left-[79%] md:left-[77%] lg:left-[84.5%] scale-[0.7] md:scale-100" />

                <Image src="/image/hero/GEROBAK BAKSO.png" alt="gerobak" width={285} height={210} className="absolute top-[115%] md:top-[84%] lg:top-[53%] xl:top-[41.8%] right-[55%] md:right-[65%] lg:right-[21%] xl:right-[65%] scale-[0.7] md:scale-100" />

                <Image src="/image/hero/WARUNG KANAN.png" alt="warung" width={410} height={342} className="absolute top-[114%] md:top-[79%] lg:top-[37%] left-[55%] md:left-[60%] lg:left-[64.5%] scale-[0.8] md:scale-100" />
                ...
                <motion.button
                    ...
                    className="absolute -bottom-[3%] px-6 py-2 w-[1100px] bg-[#F4ECA3] text-[#EB621F] rounded-xl font-bold font-barlow text-[16px] uppercase origin-center"
                >
                    Buka Undangan
                </motion.button>
            </div>
            ...
            <div className="flex lg:hidden items-center justify-center w-full h-full px-4">
                <div className="relative w-full max-w-[380px] md:max-w-[620px] h-[80vh] md:h-[85vh] max-h-[550px] md:max-h-[800px] bg-[#EB621F] rounded-xl shadow-2xl overflow-hidden flex items-center justify-center">
                    ...
                    <Image src="/image/mentahan/Mentahan-Cowo.png" alt="cowok" width={50} height={114} className="absolute top-[34%] md:top-[26%] left-[61%] md:left-[55%] -translate-x-1/2 z-10 scale-[73%] md:size-22" />
