        ...
        >
            ...
            <div className="flex lg:hidden items-center justify-center w-full h-full px-4">
                <div className=" relative w-full max-w-[380px] md:max-w-[620px] h-[80vh] md:h-[85vh] max-h-[550px] md:max-h-[800px] bg-[#EB621F] rounded-xl shadow-2xl overflow-hidden flex items-center justify-center">
                    ...
                    {/* ORANG */}
                    <Image src="/image/hero/Cewek - Kanan.png" alt="cewek" width={55} height={114} className="absolute top-[32%] md:top-[26%] left-[47%] md:left-[48%] -translate-x-1/2 z-10" />
                    <Image src="/image/hero/Char - Cowok - Kanan.png" alt="cowok" width={55} height={114} className="absolute top-[31%] md:top-[26%] left-[59%] md:left-[55%] -translate-x-1/2 z-10" />
                    ...
                    <Image src="/image/hero/Kang Bakso.png" alt="bakso" width={170} height={355} className="absolute top-[50%] md:top-[38%] left-[36%] md:left-[40%] z-40 -translate-x-1/2" />
