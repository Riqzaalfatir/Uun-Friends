          ...
          <div>
            <div>
              ...
              <div className="w-full h-[200px] sm:h-[240px] md:h-[220px] lg:h-[260px] rounded-lg overflow-hidden mb-5">
                <iframe src="https://www.google.com/maps?q=Jl.+Soekarno+Hatta+No.354,+Bandung&output=embed" width="100%" height="100%" style={{ border: 0 }} loading="lazy"></iframe>
              </div>

              <a href="https://www.google.com/maps?q=Jl.+Soekarno+Hatta+No.354,+Bandung" target="_blank" rel="noopener noreferrer" className="w-full block text-center bg-[#EB621F] text-[#F4ECA3] py-4 rounded-2xl font-bold text-[13px] sm:text-[14px] md:text-[15px] lg:text-[16px] font-barlow transition-all duration-300 ease-in-out hover:bg-[#d9551a] hover:scale-[1.02] active:scale-[0.98] shadow-md hover:shadow-xl">
